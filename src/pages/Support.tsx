...
<span className="text-primary font-label text-sm lg:text-base font-bold">FRA-01</span>
</div>
</div>
...
<h3 className="font-display font-semibold text-lg lg:text-xl">System Logs</h3>
</div>
<span className="text-on-surface-variant font-label text-xs">Live Feed</span>
</div>
<div className="bg-surface-container-lowest rounded-2xl p-4 font-mono text-sm lg:text-base leading-relaxed overflow-hidden border border-outline-variant/10">
...
<div className="flex items-center gap-4 lg:gap-6 p-4 bg-surface-container-low rounded-2xl group cursor-pointer hover:bg-surface-container-high transition-colors">
<div className="w-12 h-12 rounded-xl bg-tertiary/10 flex items-center justify-center text-tertiary">
<span className="material-symbols-outlined">description</span>
</div>
<div className="flex-1">
<h4 className="font-semibold text-on-surface">Documentation</h4>
<p className="text-on-surface-variant text-sm lg:text-base">Integration guides and API specs</p>
</div>
...
<p className="text-on-surface-variant text-sm lg:text-base">Join the Aether Protocol discord</p>
</div>
<span className="material-symbols-outlined text-outline group-hover:text-primary transition-colors">chevron_right</span>
</div>
</section>
